...
export const propertiesArray = [
  ...
  "--main-background",
  "--font-contrast-color",
  "--font-contrast-color-button",
];

export const themes = {
  darkTheme: [
    "linear-gradient(180deg, #001, #000008)",
    "#f0fffa",
    "#000d",
    "#f0fffa",
    "#001",
  ...
  originalTheme: [
    "linear-gradient(180deg, #220001, #100000)",
    "#f8fffa",
    "#ddda",
    "#220001",
    "#220001",
  ...
  patternTheme: [
    "linear-gradient(180deg, #1B233A, #102030)",
    "#f8fffa",
    "#ddda",
    "#1B233A",
    "#1B233A",
  ...
  blueTheme: [
    "linear-gradient(180deg, #00f, #00e)",
    "#f8fffa",
    "#ddda",
    "#00f",
    "#00f",
  ...
  greenTheme: [
    "linear-gradient(180deg, #00aA00, #0f9f0f)",
    "#f8fffa",
    "#ddda",
    "#0faf0f",
    "#0faf0f",
  ...
  yellowTheme: [
    "linear-gradient(180deg, #f80, #f60)",
    "#f8fffa",
    "#ddda",
    "#f80",
    "#f80",
  ...
  redTheme: [
    "linear-gradient(180deg, #5f0000, #500000)",
    "#f8fffa",
    "#ddda",
    "#5f0000",
    "#5f0000",
  ...
  purpleTheme: [
    "linear-gradient(180deg, #405, #4f0f5f)",
    "#f8fffa",
    "#ddda",
    "#405",
    "#405",
  ...
  silverTheme: [
    "linear-gradient(180deg, #4F4F4F, #404040)",
    "#f8fffa",
    "#ddda",
    "#4F4F4F",
    "#4F4F4F",
